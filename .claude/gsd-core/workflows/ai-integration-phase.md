...
```markdown
Read D:/Repos/lancet/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/Repos/lancet/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/Repos/lancet/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/Repos/lancet/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/Repos/lancet/.claude/agents/gsd-eval-planner.md for instructions.
