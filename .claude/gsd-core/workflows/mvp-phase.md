...
<required_reading>
@D:/Repos/lancet/.claude/gsd-core/references/user-story-template.md
@D:/Repos/lancet/.claude/gsd-core/references/spidr-splitting.md
...
Normalize per `@D:/Repos/lancet/.claude/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@D:/Repos/lancet/.claude/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@D:/Repos/lancet/.claude/gsd-core/references/spidr-splitting.md`. Briefly:
