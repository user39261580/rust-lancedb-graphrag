...
```
Agent(
  prompt="Read D:/Repos/lancet/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Repos/lancet/.claude/gsd-core/templates/SECURITY.md`
