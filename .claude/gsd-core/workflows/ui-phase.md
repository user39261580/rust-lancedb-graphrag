...
```markdown
Read D:/Repos/lancet/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/Repos/lancet/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/Repos/lancet/.claude/agents/gsd-ui-checker.md for instructions.
