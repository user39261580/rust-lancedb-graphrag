...
<execution_context>
@~/.copilot/gsd-core/workflows/mvp-phase.md
@~/.copilot/gsd-core/references/spidr-splitting.md
@~/.copilot/gsd-core/references/user-story-template.md
</execution_context>
...
<process>
Execute the mvp-phase workflow from @~/.copilot/gsd-core/workflows/mvp-phase.md end-to-end.
